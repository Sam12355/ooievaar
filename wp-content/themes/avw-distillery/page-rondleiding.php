...
.avw-rond-intro-lead {
    font-family: 'DM Sans', sans-serif; font-size: 18px; line-height: 1.8;
    color: rgba(54,34,29,0.75); margin-bottom: 16px;
}
...
.avw-rond-proef-item {
    padding: 28px 48px;
    border-bottom: 1px solid rgba(54,34,29,0.06);
}
...
@media (max-width: 900px) {
    ...
    .avw-rond-card, .avw-rond-proef-header, .avw-rond-proef-item, .avw-rond-cta-wrap { padding-left: 28px; padding-right: 28px; }
}
@media (max-width: 600px) {
    .avw-rond-body { width: 100%; padding-left: 16px; padding-right: 16px; }
    .avw-rond-card { padding: 24px 20px; }
    .avw-rond-proef-header, .avw-rond-proef-item, .avw-rond-cta-wrap { padding-left: 20px; padding-right: 20px; }
}
</style>
