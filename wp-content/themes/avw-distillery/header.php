        ...
        <div class="max-w-[1440px] mx-auto px-4 py-4 flex items-center justify-between gap-4">
            ...
            <div class="flex items-center gap-3 flex-shrink-0 ml-auto">
                ...
                <div class="relative hidden md:block" id="avw-lang-switcher">
                    <button id="avw-lang-btn" class="bg-white rounded-full px-3 py-2 flex items-center gap-1.5 hover:bg-gray-100 transition-all active:scale-95 shadow-sm notranslate" aria-label="Taal wisselen">
                        ...
                        <span id="avw-lang-label" class="text-black text-[13px] font-bold uppercase tracking-wider notranslate">NL</span>
                    ...
                    <div id="avw-lang-dropdown" class="notranslate" style="display:none;position:absolute;top:calc(100% + 8px);right:0;background:#fff;border-radius:12px;box-shadow:0 8px 32px rgba(0,0,0,0.14);overflow:hidden;min-width:72px;z-index:200;">
                        <a href="#" id="avw-lang-nl" onclick="avwSwitchLang('nl');return false;" class="notranslate"
                        ...
                        <a href="#" id="avw-lang-en" onclick="avwSwitchLang('en');return false;" class="notranslate"
                           style="display:flex;align-items:center;padding:10px 16px;font-family:'DM Sans',sans-serif;font-size:13px;font-weight:700;color:#36221d;text-transform:uppercase;text-decoration:none;letter-spacing:0.06em;transition:background 0.15s;"
        ...
        <div id="mobile-menu">
            <div style="padding: 8px 24px 24px;">
                ...
                <div class="avw-mob-util">
                    ...
                    <a href="#" onclick="avwSwitchLang('nl');return false;" class="avw-mob-lang notranslate" id="avw-mob-lang-nl">NL</a>
                    <a href="#" onclick="avwSwitchLang('en');return false;" class="avw-mob-lang notranslate" id="avw-mob-lang-en">EN</a>
                </div>
