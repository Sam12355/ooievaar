...
<section class="relative bg-[#36221d] pt-24 pb-10 sm:pt-28 sm:pb-14 px-4 sm:px-6 overflow-hidden">
    ...
    <div class="max-w-[1000px] mx-auto text-center relative z-10">
        <nav class="font-sans text-[#eedfcb]/70 text-[13px] uppercase tracking-widest mb-4">
            ...
            <span class="mx-2">&bull;</span>
            <a href="<?php echo wc_get_cart_url(); ?>" class="hover:text-white transition-colors"><?php esc_html_e( 'Cart', 'woocommerce' ); ?></a>
            <span class="mx-2">&bull;</span>
        ...
        <p class="font-sans text-white text-[16px] sm:text-[18px] opacity-80 drop-shadow-md">
            <?php esc_html_e( 'Secure your order of fine Dutch spirits', 'woocommerce' ); ?>
        </p>
    </div>
</section>
