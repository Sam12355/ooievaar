...
<section class="relative bg-[#36221d] pt-28 pb-16 sm:pt-36 sm:pb-20 px-4 sm:px-6 overflow-hidden">
    ...
    <div class="absolute inset-0 z-0">
        <?php
        $hero_img = file_exists( get_template_directory() . '/assets/home_about.jpg' )
            ? get_template_directory_uri() . '/assets/home_about.jpg'
            : get_template_directory_uri() . '/assets/assortment-hero-v2.png';
        ?>
        <img id="assortment-hero-img" src="<?php echo esc_url($hero_img); ?>" alt="A. van Wees Assortment Background" class="w-full object-cover opacity-60" style="object-position: center 40%; position: absolute; top: -30%; height: 160%;" />
