...
@media (max-width: 768px) {
    .avw-login-wrap { grid-template-columns: 1fr; }
}
    ...
    <div class="avw-login-wrap">
        ...
        <div class="avw-login-card">
            ...
            <div class="avw-login-links">
                <a href="<?php echo esc_url( wc_get_account_endpoint_url( 'dashboard' ) ) . '?action=register'; ?>" class="register">
                    <?php esc_html_e( 'No account? Click here to create one.', 'woocommerce' ); ?>
                </a>
        ...
        <div class="avw-login-card" style="background: rgba(19,62,35,0.02); border-color: rgba(19,62,35,0.06);">
            <h2 class="avw-login-card-title"><?php esc_html_e( 'Create Account', 'woocommerce' ); ?></h2>
