<?php get_header(); ?>
    ...
    <section id="about" class="bg-[#eedfcb] py-12 sm:py-16 md:py-20 px-4 sm:px-6 overflow-hidden">
        <div class="max-w-[1440px] mx-auto">
            ...
            <!-- Button Row -->
            <?php
            $googtrans_fp = isset(<?php get_header(); ?>
    ...
    <section id="about" class="bg-[#eedfcb] py-12 sm:py-16 md:py-20 px-4 sm:px-6 overflow-hidden">
        <div class="max-w-[1440px] mx-auto">
            ...
            $is_en_fp    = ( strpos(<?php get_header(); ?>
...
<?php get_footer(); ?>
COOKIE['googtrans']) ? <?php get_header(); ?>
...
<?php get_footer(); ?>
SERVER['REQUEST_URI'], '/en/') !== false ) || ( strpos($googtrans_fp, '/en') !== false );
            $over_url    = $is_en_fp ? home_url('/en/over/') : home_url('/nl/over/');
            $nieuws_url  = $is_en_fp ? home_url('/en/nieuws/') : home_url('/nl/nieuws/');
            ?>
            <div class="flex justify-center mt-10 sm:mt-12">
