    ...
    <section class="bg-[#e0cbb0] py-12 sm:py-16 md:py-20 px-4 sm:px-6">
        <div class="max-w-[1290px] mx-auto">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
                ...
                <!-- Card 1 -->
                <div class="product-card bg-[#eedfcb] rounded-[24px] sm:rounded-[32px] p-5 sm:p-8 flex flex-col" data-category="Esprits">
                    <div class="relative rounded-[18px] sm:rounded-[24px] overflow-hidden mb-5 sm:mb-8" style="aspect-ratio:289/203;">
                    ...
                    <div class="flex flex-col gap-3 flex-1">
                        <div class="flex items-center gap-4 flex-wrap">
                            <div class="font-['DM_Sans',sans-serif] text-[#36221d]"><span class="text-[18px]">€ </span><span class="text-[22px] font-medium">14,50</span></div>
                            <div class="border border-[rgba(0,0,0,0.3)] rounded-full px-4 py-1.5"><span class="font-['DM_Sans',sans-serif] text-[#061406] text-[13px]">Esprits</span></div>
                        </div>
                        <h3 class="font-kurversbrug font-light text-[#061406] text-[18px] sm:text-[20px] leading-snug">Bourbon vanille Stokjes esprit</h3>
                        <p class="font-sans text-black text-[15px] leading-relaxed flex-1">De handmatig opengesneden stokjes worden langdurig getrokken en gestookt...</p>
                    </div>
                </div>

                <!-- Card 2 -->
                <div class="product-card bg-[#eedfcb] rounded-[24px] sm:rounded-[32px] p-5 sm:p-8 flex flex-col" data-category="Bitters">
                    <div class="relative rounded-[18px] sm:rounded-[24px] overflow-hidden mb-5 sm:mb-8" style="aspect-ratio:289/203;">
                    ...
                    <div class="flex flex-col gap-3 flex-1">
                        <div class="flex items-center gap-4 flex-wrap">
                            <div class="font-['DM_Sans',sans-serif] text-[#36221d]"><span class="text-[18px]">€ </span><span class="text-[22px] font-medium">24,50</span></div>
                            <div class="border border-[rgba(0,0,0,0.3)] rounded-full px-4 py-1.5"><span class="font-['DM_Sans',sans-serif] text-[#061406] text-[13px]">Bitters</span></div>
                        </div>
                        <h3 class="font-kurversbrug font-light text-[#061406] text-[18px] sm:text-[20px] leading-snug">Angostura Bitter</h3>
                        <p class="font-sans text-black text-[15px] leading-relaxed flex-1">Onze Angostura wordt bereid volgens ons oude recept, dat dateert uit de tijd van de VOC.</p>
                    </div>
                </div>

                <!-- Card 3 -->
                <div class="product-card bg-[#eedfcb] rounded-[24px] sm:rounded-[32px] p-5 sm:p-8 flex flex-col" data-category="Genever">
                    <div class="relative rounded-[18px] sm:rounded-[24px] overflow-hidden mb-5 sm:mb-8" style="aspect-ratio:289/203;">
                    ...
                    <div class="flex flex-col gap-3 flex-1">
                        <div class="flex items-center gap-4 flex-wrap">
                            <div class="font-['DM_Sans',sans-serif] text-[#36221d]"><span class="text-[18px]">€ </span><span class="text-[22px] font-medium">43,15</span></div>
                            <div class="border border-[rgba(0,0,0,0.3)] rounded-full px-4 py-1.5"><span class="font-['DM_Sans',sans-serif] text-[#061406] text-[13px]">Genever</span></div>
                        </div>
                        <h3 class="font-kurversbrug font-light text-[#061406] text-[18px] sm:text-[20px] leading-snug">Mirakel van Amsterdam</h3>
                        <p class="font-sans text-black text-[15px] leading-relaxed flex-1">De Zeer Oude Genever wordt gemaakt van pure moutwijn en zeven verschillende geherdistilleerde moutwijnen...</p>
                    </div>
                </div>
